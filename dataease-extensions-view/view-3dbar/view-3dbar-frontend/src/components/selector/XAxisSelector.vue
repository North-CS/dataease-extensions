...
<!--              @blur="changeXAxisStyle('axisValue')"-->
<!--            />-->
<!--          </el-form-item>-->
...
<!--          &lt;!&ndash; 内容格式 &ndash;&gt;-->
<!--          <el-form-item-->
<!--            :label="$t('chart.content_formatter')"-->
<!--            class="form-item"-->
<!--          >-->
<!--            <el-input-->
<!--              v-model="axisForm.axisLabel.formatter"-->
<!--              type="textarea"-->
...
<script>
import {COLOR_PANEL, DEFAULT_XAXIS_STYLE, formatterType, unitList} from '@/utils/map';
