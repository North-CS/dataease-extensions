  ...
  if (chart.customAttr) {
    ...
    if (customAttr.tooltip) {
      ...
      if (formatter && formatter != '') {
        chart_option.tooltip.headerFormat = "<small style=\"fontSize:" + tooltip.textStyle.fontSize + "\"></small></br>";
      }
    }
...
export function componentStyle(chart_option, chart) {
  ...
  if (chart.customStyle) {
    ...
    if (customStyle.yAxis) {
      ...
      chart_option.yAxis.softMax = customStyle.yAxis.softMax;
      chart_option.yAxis.softMin = customStyle.yAxis.softMin;
